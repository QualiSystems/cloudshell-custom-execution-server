...
from sample_execution_server import MyCustomExecutionServerCommandHandler
...
class MyExecutionServerService(win32serviceutil.ServiceFramework):
    _svc_name_ = 'MyExecutionServerService'
    _svc_display_name_ = 'My Execution Server'
...
if __name__ == '__main__':
    if len(sys.argv) == 1:
        ...
        servicemanager.PrepareToHostSingle(MyExecutionServerService)
        servicemanager.StartServiceCtrlDispatcher()
    else:
        win32serviceutil.HandleCommandLine(MyExecutionServerService)